...
export const notificationLister = (navigation,generalWords) => {
    messaging().onNotificationOpenedApp(remoteMessage => {
        console.log(
            'Notification caused app to open from background state:',
            remoteMessage.notification, JSON.stringify(remoteMessage)
        );
        // navigation.navigate(generalWords?.settings);
    });
