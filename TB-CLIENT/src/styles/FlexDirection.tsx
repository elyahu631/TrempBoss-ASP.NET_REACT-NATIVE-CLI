...
import { TranslationContext } from './Languages/Languages';
import { FlexAlignType, I18nManager } from 'react-native';
export type DirectionsType = {
    flexDirection: string;
    isLangaugeRTL: boolean;
    isRTL: boolean;
    textAlign: string;
    alignItems: "flex-end" | "flex-start";
  };
const FlexDirection = ():DirectionsType  => {
    ...
    const flexDirection = !isRTL
        ...
        : isLangaugeRTL
            ? 'row'
            : 'row-reverse';
    const alignItems:"auto" | FlexAlignType | undefined = !isRTL
        ? isLangaugeRTL
            ? 'flex-end'
            : 'flex-start'
        : isLangaugeRTL
